...
namespace ConsoleApp2
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="dbObject")]
    ...
    partial void DeleteUniversitati(Universitati instance);
		...
		public DataClasses1DataContext() : 
				base(global::ConsoleApp2.Properties.Settings.Default.dbObjectConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnNumeFacChanging(string value);
    partial void OnNumeFacChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NumeFac", DbType="Text NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
		public string NumeFac
		{
			get
			{
				return this._NumeFac;
			}
			set
			{
				if ((this._NumeFac != value))
				{
					this.OnNumeFacChanging(value);
					this.SendPropertyChanging();
					this._NumeFac = value;
					this.SendPropertyChanged("NumeFac");
					this.OnNumeFacChanged();
				}
			}
		}
